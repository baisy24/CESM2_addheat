...
!********************* ADD HEAT EDITS **********************
          xxh      ! FA/CL - Additional applied heating
!************************ END EDITS ************************
...
!*********************** ADD HEAT EDITS **********************
          state_out%xxh(i,k)       = state_in%xxh(i,k) !FA/CA  
!************************* END EDITS *************************
       end do
    end do
...
!********************** ADD HEAT EDITS *********************
  allocate(state%xxh(psetcols,pver), stat=ierr)
  if ( ierr /= 0 ) call endrun('physics_state_alloc error: allocation error for state%xxh')
!************************* END EDITS ***********************
...
!******************* ADD HEAT EDITS *******************
  state%xxh(:,:) = 0.0 !FA/CL cannot be inf here --HB
!********************** END EDITS *********************
